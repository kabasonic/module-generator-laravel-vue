...
{{--</head>--}}
{{--<body>--}}
{{--<div id="myBlock" style="width: {{ $width ?? '100px' }}; height: {{ $height ?? '100px' }}; background-color: #f00; cursor: pointer;">Click me!</div>--}}
{{--<script>--}}
{{--    document.getElementById("myBlock").addEventListener("click", function() {--}}
{{--        window.location.href = "{{ $clickout ?? 'https://google.com' }}";--}}
{{--    });--}}
{{--</script>--}}
{{--</body>--}}
{{--</html>--}}
